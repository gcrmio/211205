...
module.exports.viewStatus1 = function(req, res){
    let query = `SELECT 
...
module.exports.viewStatus2 = function(req, res){
    let query = `SELECT 
	                test_gsal01mt.PRTNRID PARTNER_ID,
	                test_gprt01mt.PRTNRNM PARTNER_NAME,
	                COUNT(CSTMSEQ) "TTL",
...
module.exports.viewStatus3 = function(req, res){
    let query = `SELECT 
	                test_gsal01mt.PRTNRID PARTNER_ID,
	                test_gprt01mt.PRTNRNM PARTNER_NAME,
	                COUNT(CSTMSEQ) "TTL",
...
module.exports.viewStatus4 = function(req, res){
    let query = `SELECT 
	                test_gsal01mt.PRTNRID PARTNER_ID,
	                test_gprt01mt.PRTNRNM PARTNER_NAME,
	                COUNT(CSTMSEQ) "TTL",
